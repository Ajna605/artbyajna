...
function submitOrder(event) {
  ...
  const order = { reference, status: "Awaiting verification", name: `${form.get("firstName")} ${form.get("lastName")}`, email: form.get("email"), phone: form.get("phone"), address: form.get("address"), country: form.get("country"), payment: form.get("payment"), message: form.get("message"), internalNote: "Customer confirmed bank transfer via checkout.", products: cart, date: new Date().toLocaleDateString("en-GB") };
